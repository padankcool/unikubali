    ...
    <main className="min-h-screen bg-gray-50 font-sans">
      ...
      <nav className="bg-white shadow-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {/* Bagian Kiri: Logo */}
          <div className="text-3xl font-extrabold text-gray-900 tracking-widest cursor-pointer">
            UNIKUBALI
          </div>

          {/* Bagian Tengah: Menu Utama */}
          <div className="hidden md:flex gap-10 font-bold text-gray-600">
      ...
      {/* Area Modul 2 */}
      <div className="flex items-center justify-center h-64 border-4 border-dashed border-gray-300 m-8 rounded-xl text-gray-500 font-bold text-xl">
