...
export default function Navbar() {
  ...
  return (
    <nav style={{ 
      ...
      {/* Ikon Logo Sosmed di Kanan (Berubah Warna Saat Hover) */}
      <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
        ...
        {/* TikTok */}
        <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" style={iconBoxStyle}
        ...
        {/* WhatsApp */}
        <a href="https://whatsapp.com" target="_blank" rel="noopener noreferrer" style={iconBoxStyle}
